...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MRJCameraTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mrjlovetian@gmail.com/MRJCameraTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mrjlovetian@gmail.com' => 'mrjyuhongjiang@gmail.com' }
  s.source           = { :git => 'https://github.com/mrjlovetian@gmail.com/MRJCameraTool.git', :tag => s.version.to_s }
